    ...
    while Round > 0:
        ...
        if  Player.Focus < 100:
                    ...
                    menu:
                        ...
                        "[LauraX.Name]. . .[[jump in]" if "unseen" not in LauraX.RecentActions and "join" not in Player.RecentActions and LauraX.Loc == bg_current:
...
label Laura_Sex_P:   #rkelj
    ...
    if "no sex" in LauraX.DailyActions:
        $ temp_modifier -= 15 if "no sex" in LauraX.RecentActions else 5
...
label Laura_Sex_A: #rkelj
    ...
    if "no anal" in LauraX.DailyActions:
        $ temp_modifier -= 5
        $ temp_modifier -= 10 if "no anal" in LauraX.RecentActions else 0
...
label Laura_Sex_H: #rkelj
    ...
    if "no hotdog" in LauraX.DailyActions:
        $ temp_modifier -= 5
        $ temp_modifier -= 10 if "no hotdog" in LauraX.RecentActions else 0
