...
image Laura_sprite standing:
    LiveComposite(
        ...
        (145,560), ConditionSwitch(
            ...
            "LauraX.outfit['bottom'] and LauraX.outfit['bottom'] != '_other_skirt' and not LauraX.upskirt", Null(),
        ...
        (0,0), ConditionSwitch(
            ...
            "not LauraX.outfit['front_inner_accessory']", Null(),
            ...
            "LauraX.outfit['bottom'] != '_other_skirt' and LauraX.outfit['bottom'] and not LauraX.upskirt", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", "images/LauraSprite/Laura_Sprite_Barbell_Pussy.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSprite/Laura_Sprite_Ring_Pussy.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
        ...
        (0,0), ConditionSwitch(
            ...
            "LauraX.upskirt", ConditionSwitch(
                        ...
                        "LauraX.outfit['bottom'] == '_other_skirt'", "images/LauraSprite/Laura_Sprite_SkirtCos_Up.png",
                        "LauraX.outfit['bottom'] == '_skirt'", "images/LauraSprite/Laura_Sprite_Skirt_Up.png",
                        "True", Null(),
                        ),
            "True", ConditionSwitch(

                    "LauraX.outfit['bottom'] == '_other_skirt'", "images/LauraSprite/Laura_Sprite_SkirtCos.png",
        ...
        (0,0), ConditionSwitch(
            ...
            "LauraX.outfit['bottom'] == '_skirt' or LauraX.outfit['bottom'] == '_other_skirt'", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", ConditionSwitch(
            ...
            "LauraX.outfit['front_inner_accessory'] == '_ring'", ConditionSwitch(
        ...
        (0,0), ConditionSwitch(
            ...
            "LauraX.outfit['bottom'] == '_other_skirt'", Null(),
        ...
        (0,0), ConditionSwitch(
            ...
            "not LauraX.outfit['front_inner_accessory']", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", "images/LauraSprite/Laura_Sprite_Barbell_Tits.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSprite/Laura_Sprite_Ring_Tits.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
        ...
        (0,0), ConditionSwitch(
            ...
            "LauraX.outfit['front_outer_accessory'] == '_suspenders' and not LauraX.outfit['bra'] and not LauraX.top_pulled_up", "images/LauraSprite/Laura_Sprite_Acc_Suspenders2.png",
            "LauraX.outfit['front_outer_accessory'] == '_suspenders2'", "images/LauraSprite/Laura_Sprite_Acc_Suspenders2.png",
            "LauraX.outfit['front_outer_accessory'] == '_suspenders'", "images/LauraSprite/Laura_Sprite_Acc_Suspenders1.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
        ...
        (0,0), ConditionSwitch(
            ...
            "not LauraX.outfit['front_inner_accessory'] or (not LauraX.outfit['top'] and not LauraX.outfit['bra'])", Null(),
            "LauraX.outfit['top'] == '_jacket'", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'",  "images/LauraSprite/Laura_Sprite_Barbell_TitsC.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSprite/Laura_Sprite_Ring_TitsC.png",
            "True", Null(),
            ),
...
image Laura_Doggy_Body:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
            ...
            "not LauraX.outfit['bottom']", Null(),
            "LauraX.outfit['front_outer_accessory'] == '_suspenders'", "images/LauraDoggy/Laura_Doggy_Suspenders.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
...
image Laura_Sex_Body:
    ...
    contains:
        ...
        ConditionSwitch(
            "not LauraX.outfit['front_inner_accessory']", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", "images/LauraSex/Laura_Sex_Barbell_Tits.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSex/Laura_Sex_Ring_Tits.png",
            "True", Null(),
            )
    contains:
    ...
    contains:
        ...
        ConditionSwitch(
            "not LauraX.outfit['front_inner_accessory'] or LauraX.top_pulled_up", Null(),
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", "images/LauraSex/Laura_Sex_Barbell_Tits_C.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSex/Laura_Sex_Ring_Tits_C.png",
            "True", Null(),
            )
    contains:
        ...
        ConditionSwitch(
            "not LauraX.outfit['bottom']", Null(),
            "LauraX.outfit['front_outer_accessory'] == '_suspenders' and not LauraX.outfit['bra'] and not LauraX.top_pulled_up", "images/LauraSex/Laura_Sex_Suspenders.png",
            "LauraX.outfit['front_outer_accessory'] == '_suspenders2'", "images/LauraSex/Laura_Sex_Suspenders.png",
            "LauraX.outfit['front_outer_accessory'] == '_suspenders'", "images/LauraSex/Laura_Sex_Suspenders_Up.png",
            "True", Null(),
            )
    contains:
...
image Laura_Sex_Legs:
    ...
    contains:
        ...
        ConditionSwitch(
            ...
            "LauraX.outfit['front_inner_accessory'] == '_barbell'", "images/LauraSex/Laura_Sex_Barbell_Pussy_C.png",
            "LauraX.outfit['front_inner_accessory'] == '_ring'", "images/LauraSex/Laura_Sex_Ring_Pussy_C.png",
            "True", Null(),
            )
    contains:
...
label Laura_Sex_Launch(Line=primary_action):
    ...
    if primary_action == "in" or primary_action == "anal":
        if LauraX.outfit['bottom'] or LauraX.hose_number() >= 5:
            $ LauraX.upskirt = 1
...
image Laura_TJ_LeftArm:
    ...
    contains:
        ...
        ConditionSwitch(
                        "not LauraX.outfit['front_inner_accessory']",Null(),
                        "True",       "images/LauraSex/Laura_Titjob_Left_[LauraX.outfit['front_inner_accessory']].png",
                        )
...
image Laura_TJ_RightArm:
    ...
    contains:
        ...
        ConditionSwitch(
                        "not LauraX.outfit['front_inner_accessory']",Null(),
                        "True",       "images/LauraSex/Laura_Titjob_Right_[LauraX.outfit['front_inner_accessory']].png",
                        )
