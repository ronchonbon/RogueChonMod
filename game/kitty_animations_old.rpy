...
image Kitty_Squint:
    "images/KittySprite/Kitty_sprite standing_eyes_Sexy.png"
    choice:
        3.5
    choice:
        3.25
    choice:
        3
    "images/KittySprite/Kitty_sprite standing_eyes_Squint.png"
    .25
    repeat
...
image Kitty_Drip_Mask:
    ...
    contains:
        "images/KittySprite/Kitty_sprite standing_WetMask.png"
        offset (-225,-560)

image Kitty_Drip_MaskP:

    contains:
        "images/KittySprite/Kitty_sprite standing_WetMaskP.png"
        offset (-225,-560)
...
image Kitty_sex_legs:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
            "not Player.sprite or Player.cock_position != 'footjob'", Null(),
...
image Kitty_sex_Pussy:
    ...
    contains:
        ...
        ConditionSwitch(
                ...
                "Player.sprite and Player.cock_position == 'in' and action_speed >= 3", AlphaMask("Kitty_sex_Zero_animation3", "Kitty_Pussy_Fucking_Mask"),
                "Player.sprite and Player.cock_position == 'in' and action_speed >= 2", AlphaMask("Kitty_sex_Zero_animation2", "Kitty_Pussy_Fucking_Mask"),
                "Player.sprite and Player.cock_position == 'in' and action_speed", AlphaMask("Kitty_sex_Zero_animation1", "Kitty_Pussy_Open_Mask"),
                "Player.sprite and Player.cock_position == 'in'", AlphaMask("Kitty_sex_Zero_animation0", "Kitty_Pussy_Open_Mask"),
                "True", Null(),
                )
    contains:

        ConditionSwitch(
                "not KittyX.spunk['pussy'] or not Player.sprite or Player.cock_position != 'in' or not action_speed", Null(),
...
image Kitty_sex_Anus:
    ...
    contains:
        ...
        ConditionSwitch(
                "not KittyX.spunk['anus'] or not Player.sprite or Player.cock_position != 'anal' or not action_speed", Null(),
...
image Kitty_sprite Doggy Blink:
...
image Kitty_Doggy_Ass:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
            ...
            "KittyX.spunk['pussy'] and Player.cock_position == 'in'",Null(),
...
image Kitty_Doggy_Shins:
    ...
    contains:
        ...
        ConditionSwitch(
            "not Player.sprite or Player.cock_position == 'footjob'", ConditionSwitch(
...
image Kitty_BJ_Head:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(
            ...
            "action_speed <= 2 or action_speed == 5 or not renpy.showing('Kitty_sprite blowjob')", ConditionSwitch(
        ...
        (0,0), ConditionSwitch(
            ...
            "action_speed == 3 and renpy.showing('Kitty_sprite titjob')", "images/KittyBJFace/Kitty_BJ_mouth_Tongue.png",
            "action_speed >= 5 and renpy.showing('Kitty_sprite titjob')", "images/KittyBJFace/Kitty_BJ_mouth_Kiss.png",
        ...
        (428,605), ConditionSwitch(
            ...
            "not renpy.showing('Kitty_sprite blowjob')", Null(),
        ...
        (0,0), ConditionSwitch(
            ...
            "action_speed >= 5 and renpy.showing('Kitty_sprite titjob')", "images/KittyBJFace/Kitty_BJ_Spunk_Kiss.png",
...
label Kitty_BJ_Launch(Line=primary_action):
    ...
    show Kitty_sprite standing zorder KittyX.sprite_layer:
        alpha 0
    show Kitty_sprite blowjob zorder 150:
        pos (645,510)
    return
...
label Kitty_TJ_Launch(Line=primary_action):
    ...
    show Kitty_sprite titjob zorder 150
    $ Player.sprite = 1
    hide blackscreen onlayer black with dissolve
    return

label Kitty_TJ_Reset:
    if not renpy.showing("Kitty_sprite titjob"):
        return
    call hide_girl(KittyX)
    $ Player.sprite = 0
...
label Kitty_HJ_Launch(Line=primary_action):
    ...
    call hide_girl(KittyX)
    if Line == "L":
        show Kitty_sprite standing zorder KittyX.sprite_layer at sprite_location(stage_right):
            alpha 1
    ...
    if Line != "cum":
        ...
        $ action_speed = 1
    pause .5
    show Kitty_sprite handjob zorder 150 at sprite_location(stage_center) with easeinbottom:

        offset (100,250)
    return

label Kitty_HJ_Reset:
    if not renpy.showing("Kitty_sprite handjob"):
        return
    $ action_speed = 0
    hide Kitty_sprite handjob with easeoutbottom
    call hide_girl(KittyX)
    show Kitty_sprite standing zorder KittyX.sprite_layer at sprite_location(KittyX.sprite_location):
        alpha 1
