label Player_Cumming(Girl=0, approval_bonus=approval_bonus):
    ...
    elif main_action == "sex" or main_action == "anal":
    ...
    menu:
        ...
        "Ask to cum in her mouth":
            ...
            jump Girl_In_mouth
        "Cum in her mouth without asking" if main_action == "blowjob" or main_action == "handjob" or main_action == "titjob" and action_context != "swap":
            $ action_context = "auto"
            jump Girl_In_mouth

        "Ask to cum inside her" if main_action == "sex" and action_context != "swap":
            $ action_context = "asked"
            jump Girl_Creampie_P
        "Ask to cum inside her" if main_action == "anal" and action_context != "swap":
            $ action_context = "asked"
            jump Girl_Creampie_A

        "Cum inside her" if main_action == "sex" and action_context != "swap":
            $ action_context = "auto"
            jump Girl_Creampie_P
        "Cum inside her" if main_action == "anal" and action_context != "swap":
            $ action_context = "auto"
            jump Girl_Creampie_A
        "Cum outside":
            menu:
        ...
        "Pull back" if main_action != "psy" and Girl.location == bg_current and action_context != "swap":
...
label Girl_Warn_Her:
    ...
    if main_action == "sex" and Girl.event_counter["creampied"] >= 5:
    ...
    elif main_action == "sex" and Girl.event_counter["creampied"] and D20 >= 10:
    ...
    elif main_action == "anal" and Girl.event_counter["anal_creampied"] >= 5:
    ...
    elif main_action == "anal" and Girl.event_counter["anal_creampied"] and D20 >= 10:
    ...
    elif main_action != "anal" and Girl.event_counter["swallowed"] >= 5:
        ...
        if renpy.showing(Girl.tag+" handjob") and Girl.action_counter["handjob"]:
            ...
            jump Girl_Facial
        elif (renpy.showing(Girl.tag+" doggy") or renpy.showing(Girl.tag+" sex")) and Girl.action_counter["sex"] and main_action == "sex":
            "She gently pushes you back off of her."
            jump Girl_Cum_Outside
        elif (renpy.showing(Girl.tag+" doggy") or renpy.showing(Girl.tag+" sex")) and Girl.action_counter["anal"] and main_action == "anal":
            "She gently pushes you back off of her."
            jump Girl_Cum_Outside
...
label Girl_Creampie_P:
    if main_action == "sex" and action_context == "auto":
        $ Player.cock_position = "sex"
        $ Girl.spunk["pussy"] = True
        $ Player.spunk = "in"
        $ action_speed = 0
...
label Girl_Creampie_A:
    ...
    if main_action == "anal" and action_context == "auto":
        $ Player.cock_position = "anal"
        $ Girl.spunk["anus"] = True
        $ Player.spunk = "anal"
        $ action_speed = 0
...
label Girl_CleanCock(Girl):
    ...
    $ Player.cock_position = "out"
    $ action_speed = 0
    if main_action == "anal" and not approval_check(Girl, 1600, taboo_modifier=1) and not Girl.addiction >= 80:
        if Girl == JeanX:
    ...
    $ Player.spunk = 0
    $ Girl.change_face("_sexy")
    if main_action in ("fondle_breast","suck breast"):
        call shift_view (Girl, "breasts")
    elif main_action in ("fondle_pussy","eat_pussy","fondle_ass","finger_ass","eat_ass","fondle_thighs"):
...
label Girl_Cumming(Girl=0, Quick=0, temp_Girls=[]):
    ...
    if main_action != "masturbation":
        ...
        if (main_action == "blowjob" or main_action == "handjob") and not Player.offhand_action:
            pass
        elif Partner != Girl:
...
label Partner_Cleanup_Check(Girl=0, B=0):
    ...
    if Partner == JeanX and not approval_check(Partner, 600, "LO") and Partner.likes[Girl.tag] < (500-2*B):
        ...
        $ Partner.change_face("_sly", 1,eyes="_psychic")
