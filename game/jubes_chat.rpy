...
label Jubes_OtherWoman(counter=0):
    ...
    menu:
        ...
        "What she doesn't know won't hurt her.":
            ...
            if not ApprovalCheck(JubesX, 1800, Bonus = -counter):
                $ JubesX.change_face("angry", 1)
            ...
            "Polite":
                menu:
                    ...
                    "\"girl\".":
                        ...
                        $ JubesX.petname = "girl"
                        if "boyfriend" in JubesX.player_petnames or ApprovalCheck(JubesX, 600, "L"):
                            $ JubesX.change_face("sexy", 1)
                    ...
                    "\"boo\".":
                        ...
                        $ JubesX.petname = "boo"
                        if "boyfriend" in JubesX.player_petnames or ApprovalCheck(JubesX, 700, "L"):
                            $ JubesX.change_face("sexy", 1)
                    ...
                    "\"baby\".":
                        ...
                        $ JubesX.petname = "baby"
                        if "boyfriend" in JubesX.player_petnames or ApprovalCheck(JubesX, 500, "L"):
                            $ JubesX.change_face("sexy", 1)
                    ...
                    "\"sexy\".":
                        ...
                        $ JubesX.petname = "sexy"
                        if "lover" in JubesX.player_petnames or ApprovalCheck(JubesX, 800):
                            $ JubesX.change_face("sexy", 1)
                    ...
                    "\"lover\".":
                        ...
                        if "lover" in JubesX.player_petnames or ApprovalCheck(JubesX, 1200):
                            $ JubesX.change_face("sexy", 1)
                            ch_v "I know."
                        else:
                            $ JubesX.change_face("angry", 1)
            ...
            "Risky":
                ...
                menu:
                    ...
                    "\"slave\".":
                        ...
                        if "master" in JubesX.player_petnames or ApprovalCheck(JubesX, 800, "O"):
                            $ JubesX.change_face("bemused", 1)
                            ch_v "As you wish, [JubesX.player_petname]."
                        else:
                            $ JubesX.change_face("angry", 1)
                    ...
                    "\"pet\".":
                        ...
                        $ JubesX.petname = "pet"
                        if "master" in JubesX.player_petnames or ApprovalCheck(JubesX, 650, "O"):
                            $ JubesX.change_face("bemused", 1)
                    ...
                    "\"slut\".":
                        ...
                        $ JubesX.petname = "slut"
                        if "sex friend" in JubesX.player_petnames or ApprovalCheck(JubesX, 900, "OI"):
                    ...
                    "\"whore\".":
                        ...
                        if "fuckbuddy" in JubesX.player_petnames or ApprovalCheck(JubesX, 1000, "OI"):
                            $ JubesX.change_face("sly")
                            ch_v "Ouch. . ."
                        else:
                            $ JubesX.change_face("angry", 1)
                    ...
                    "\"sugartits\".":
                        ...
                        if "sex friend" in JubesX.player_petnames or ApprovalCheck(JubesX, 1400):
                            $ JubesX.change_face("sly", 1)
                            ch_v "Huh?"
                        else:
                            $ JubesX.change_face("angry", 1)
                    ...
                    "\"sex friend\".":
                        ...
                        if "sex friend" in JubesX.player_petnames or ApprovalCheck(JubesX, 600, "I"):
                            $ JubesX.change_face("sly")
                            ch_v "Yeah. . ."
                        else:
                            $ JubesX.change_face("angry", 1)
                    ...
                    "\"fuckbuddy\".":
                        ...
                        if "fuckbuddy" in JubesX.player_petnames or ApprovalCheck(JubesX, 700, "I"):
                            $ JubesX.change_face("sly")
                            ch_v "Yup."
                        else:
                            $ JubesX.change_face("angry", 1)
                    ...
                    "\"baby girl\".":
                        ...
                        if "daddy" in JubesX.player_petnames or ApprovalCheck(JubesX, 1200):
                            $ JubesX.change_face("smile", 1)
                            ch_v "I guess?"
                        else:
                            $ JubesX.change_face("angry", 1)
...
label Jubes_Wardrobe_Menu:
    ...
    menu Jubes_Clothes_Over:
        ...
        "Why don't you go with no jacket?" if JubesX.accessory:
            $ JubesX.change_face("bemused", 1)
            if JubesX.top or (ApprovalCheck(JubesX, 800, TabM=3) and (JubesX.bra or JubesX.SeenChest)):
        ...
        "Why don't you go with no [JubesX.top]?" if JubesX.top:
            $ JubesX.change_face("bemused", 1)
            if ApprovalCheck(JubesX, 800, TabM=3) and (JubesX.bra or JubesX.SeenChest):
                ch_v "Sure."
            elif ApprovalCheck(JubesX, 600, TabM=0):
                call Jubes_NoBra
                if not _return:
        ...
        "Try on that pink tubetop." if JubesX.top != "tube_top":
            $ JubesX.change_face("bemused")
            if not JubesX.top:
        ...
        "Maybe just throw on a towel?" if JubesX.top != "towel":
            $ JubesX.change_face("bemused", 1)
        ...
        menu:
            ...
            "Then you could slip something on under it. . .":
                if JubesX.SeenChest and ApprovalCheck(JubesX, 1000, TabM=3):
                    ...
                    ch_v "Oh, I was just warning -you-. . ."
                    $ JubesX.blushing = 0
                elif ApprovalCheck(JubesX, 900, TabM=2) and "lace_bra" in JubesX.Inventory:
    ...
    menu Jubes_Clothes_Legs:
        ...
        "Maybe go without the [JubesX.legs]." if JubesX.legs:
            $ JubesX.change_face("sexy", 1)
            if JubesX.SeenPanties and JubesX.underwear and ApprovalCheck(JubesX, 500, TabM=5):
                ch_v "Ok, sure."
            elif JubesX.SeenPussy and ApprovalCheck(JubesX, 900, TabM=4):
                ch_v "Yeah, ok."
            elif ApprovalCheck(JubesX, 1300, TabM=2) and JubesX.underwear:
                ch_v "For you, fine. . ."
            elif ApprovalCheck(JubesX, 700) and not JubesX.underwear:
        ...
        "Add leather_pants" if JubesX.legs != "pants":
            ch_p "You look great in those leather_pants"
            ch_v "Yeah, ok."
            $ JubesX.legs = "pants"

        "Add jeans_shorts" if JubesX.legs != "shorts":
    ...
    menu Jubes_Clothes_Under:
        "Tops":
            menu:
                "How about you lose the [JubesX.bra]?" if JubesX.bra:
                    ...
                    if JubesX.SeenChest and ApprovalCheck(JubesX, 900, TabM=2.7):
                        ...
                        if JubesX.Taboo:
                            ...
                            ch_v "Maaaybe. . ."
                    elif JubesX.accessory == "jacket" and ApprovalCheck(JubesX, 600, TabM=2):
                        ch_v "This jacket is a bit revealing. . ."
                    elif JubesX.top and ApprovalCheck(JubesX, 500, TabM=2):
                        ch_v "I guess I could. . ."
                    elif not JubesX.top:
                        call Display_DressScreen (JubesX)
                        if not _return:
                ...
                "Add sports_bra" if JubesX.bra != "sports_bra":
                ...
                "Add bikini_top" if JubesX.bra != "bikini_top" and "bikini_top" in JubesX.Inventory:
                    ch_p "I like that bikini top."
                    if bg_current == "bg_pool":
                        ch_v "K."
                        $ JubesX.bra = "bikini_top"
                    else:
        ...
        "Panties":
            ...
            menu:
                ...
                "I like those bikini bottoms." if "bikini_bottoms" in JubesX.Inventory and JubesX.underwear != "bikini_bottoms":
                    if bg_current == "bg_pool":
                        ch_v "K."
                        $ JubesX.underwear = "bikini_bottoms"
                    else:
    ...
    menu Jubes_Clothes_Misc:
        ...
        "Add ring piercings" if JubesX.piercings != "ring" and (JubesX.SeenPussy or JubesX.SeenChest):
        ...
        "Add barbell piercings" if JubesX.piercings != "barbell" and (JubesX.SeenPussy or JubesX.SeenChest):
