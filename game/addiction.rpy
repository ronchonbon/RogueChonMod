label first_addicted(Girl=0): #rkeljs
        ...
        if Girl.Event[1] == 1:
                ...
                if Girl == RogueX:
                        ...
                        ch_s "[Girl.Petname], I was wondering if you could help me with a problem I've been having. . ."
        ...
        menu:
            ...
            "What, you just want to touch my face? No thanks." if Girl != JubesX:
                    if Approvalcheck(Girl, 500, "L",Alt=[[RogueX,JeanX],400]) or Girl.action_counter["kiss"]:
            ...
            "You want to drink my blood? No thanks." if Girl == JubesX:
                    if Approvalcheck(Girl, 500, "L") or Girl.action_counter["kiss"]:
                            $ Girl.change_stat("love", 200, -3)
                            $ Girl.change_stat("inhibition", 50, 3)
                            $ Girl.Brows = "confused"
                            $ Girl.Eyes = "surprised"
...
label Addicted_Ultimatum(AddictStore=Girl.Addict): #rkeljs
        ...
        $ temp_modifier = int(Girl.Addict/2)
        if Girl.Addict >= 80:
                    $ between_event_count += 2
        elif Girl.Addict >= 50:
        ...
        while between_event_count:
            ...
            menu Addict_Ultimatum_Menu:
                ...
                "How about a kiss?":
                        if Girl.action_counter["kiss"] or Approvalcheck(Girl, 600, "LI",Alt=[[RogueX,JeanX],560]) or Girl.Petname in ("master", "sir"):
                                $ Girl.Forced = 0
                                $ Girl.change_stat("lust", 80, 3)
                                $ Girl.change_stat("love", 80, 6)
                                $ Girl.change_face("sexy")
...
label first_addicted_End: #rkeljs
...
label Addicted_Fix_Beg: #rkeljs
        ...
        if Girl.Petname in ("master", "sir"):
                #if she is obedient
                $ Girl.change_face("sad")
                if Girl.Addict <= 80 or "beg" in Girl.recent_history:
                        if Girl == RogueX:
                ...
                menu:
                    ...
                    if Girl.Petname in ("master", "sir"):
                            ...
                            if Girl == RogueX:
                                    ...
                                    ch_s "Could you touch me again, [Girl.Petname]?"
                            elif Girl == JubesX:
                                    ch_v "Could you let me touch you again, [Girl.Petname]?"
                    else:
                            if Girl == RogueX:
        ...
        if Girl == RogueX:
                ...
                if Girl.Event[1] < 11:
                    ...
                    if "forced tag" in Girl.recent_history:
                            ...
                            ch_s ". . . I did enjoy that, [Girl.Petname]."
                ...
                if Girl.Event[1] < 11:
                    ...
                    if "forced tag" in Girl.recent_history:
                            ...
                            ch_v "Hmmmm, that was nice, [Girl.Petname]."
