...
layeredimage Kitty_standing_fondling_animations:
    if primary_action == "lesbian" or not girl_offhand_action or focused_Girl != KittyX:
            Null()
    elif primary_action != "sex" and girl_offhand_action in "finger_pussy" and KittyX.lust >= 70:
    ...
    if second_girl_primary_action != "masturbation" or not second_girl_offhand_action or focused_Girl == KittyX:
        Null()
    elif primary_action != "sex" and second_girl_offhand_action == "finger_pussy" and KittyX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
