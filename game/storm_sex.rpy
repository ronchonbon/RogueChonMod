...
label Storm_Masturbate: #(Situation = Situation):
    ...
    if not StormX.Mast and Approval:
            ...
            elif StormX.Love >= StormX.Obed and StormX.Love >= StormX.Inbt:
                $ StormX.FaceChange("sexy")
                $ StormX.Brows = "sad"
                $ StormX.Mouth = "smile"
    ...
    #Second time+ initial dialog
            ...
            elif Approval and "masturbation" in StormX.RecentActions:
                $ StormX.FaceChange("sexy", 1)
                ch_s "I suppose that I was not. . . finished. . ."
                jump Storm_M_Prep
            elif Approval and "masturbation" in StormX.DailyActions:
                $ StormX.FaceChange("sexy", 1)
    ...
    if StormX.Forced:
            ...
            $ StormX.RecentActions.append("angry")
            $ StormX.DailyActions.append("angry")
            $ StormX.RecentActions.append("no masturbation")
            $ StormX.DailyActions.append("no masturbation")
            return
...
label Storm_M_Prep:
    ...
    if "unseen" in StormX.RecentActions:
            $ StormX.FaceChange("sexy")
            $ StormX.Eyes = "closed"
            $ StormX.ArmPose = 2
    ...
    $ StormX.RecentActions.append("masturbation")
    $ StormX.DailyActions.append("masturbation")
    ...
    while Round >=0:
        ...
        if  Player.Focus < 100:
                    ...
                    menu:
                        ...
                        "[StormX.Name]. . .[[jump in]" if "unseen" not in StormX.RecentActions and "join" not in Player.RecentActions and StormX.Loc == bg_current:
                                "[StormX.Name] slows what she's doing with a sly grin."
                                ch_s "Enjoying yourself?"
                                $ Situation = "join"
                                call Storm_Masturbate
                        "\"Ahem. . .\"" if "unseen" in StormX.RecentActions and StormX.Loc == bg_current:
                        ...
                        "Change what I'm doing":
                                menu:
                                    ...
                                    "Threesome actions (locked)" if not Partner or "unseen" in StormX.RecentActions or StormX.Loc != bg_current:
                                        pass
                                    "Threesome actions" if Partner and "unseen" not in StormX.RecentActions and StormX.Loc == bg_current:
                                        menu:
        ...
        if Player.Focus >= 100 or StormX.Lust >= 100:
                    ...
                    if Player.Focus >= 100:
                        if "unseen" not in StormX.RecentActions:
                            ...
                            $ Player.Focus = 95
                            if StormX.Loc == bg_current or StormX.Loc == "bg desk":
                                    jump Storm_M_Interupted
...
label Storm_M_Interupted:
    ...
    if "unseen" in StormX.RecentActions:
                ...
                call Storm_First_Bottomless(1)
                $ StormX.FaceChange("confused", 1, Eyes="surprised")
                if StormX.Loc == "bg desk":
                ...
                if Trigger2 == "jackin":
                        ...
                        menu:
                            ...
                            "A little while, it was an excellent show.":
                                    ...
                                    if StormX.Love >= 800 or StormX.Obed >= 500 or StormX.Inbt >= 500:
                                        $ temp_modifier += 10
                                        $ StormX.Statup("Lust", 90, 5)
                                    ch_s "and I have been missing a show myself. . ."

                            "I. . . just got here?":
                                    $ StormX.FaceChange("angry",1, Eyes="down")
                                    $ StormX.Statup("Love", 70, 2)
                                    $ StormX.Statup("Love", 90, 1)
                                    $ StormX.Statup("Obed", 50, 2)
                                    $ StormX.Statup("Obed", 70, 2)
    ...
    if StormX.Loc != bg_current and StormX.Loc != "bg desk":
            return
    ...
    menu:
        ...
        "You could just keep going. . ." if Player.Semen:
                ...
                if StormX.Action and Round >= 10:
                    ...
                    ch_s "Give me a moment to recover. . ."
        "I'm good here. [[Stop]":
                if StormX.Love < 800 and StormX.Inbt < 500 and StormX.Obed < 500:
                    $ StormX.OutfitChange()
                $ StormX.FaceChange("normal")
                $ StormX.Brows = "confused"
                ch_s ". . . fine then. . ."
...
label Storm_Sex_P:
    ...
    if "no sex" in StormX.DailyActions:
        $ temp_modifier -= 5
        $ temp_modifier -= 10 if "no sex" in StormX.RecentActions else 0
    ...
    if not StormX.Sex and "no sex" not in StormX.RecentActions:
            #first time
            $ StormX.FaceChange("surprised", 1)
            $ StormX.Mouth = "kiss"
    ...
    if not StormX.Sex and Approval:
            ...
            if StormX.Forced:
                $ StormX.FaceChange("sad")
                $ StormX.Statup("Love", 70, -30, 1)
                $ StormX.Statup("Love", 20, -20, 1)
            ...
            elif "sex" in StormX.RecentActions:
                ch_s "Again? [StormX.Petname], you are a lion!"
                jump Storm_SexPrep
            elif "sex" in StormX.DailyActions:
    ...
    if Approval >= 2:
            ...
            elif "no sex" in StormX.DailyActions:
            ...
            $ StormX.FaceChange("angry")
            if "no sex" in StormX.RecentActions:
                ch_s "I am afraid that \"no\" is my final answer, [StormX.Petname]."
            elif Taboo and "tabno" in StormX.DailyActions and "no sex" in StormX.DailyActions:
            ...
            menu:
                extend ""
                "Sorry, never mind." if "no sex" in StormX.DailyActions:
                        $ StormX.FaceChange("bemused")
                        ch_s "I can appreciate your. . . desires."
                        return
                "Maybe later?" if "no sex" not in StormX.DailyActions:
                        $ StormX.FaceChange("sexy")
                        ...
                        if Taboo:
                            ...
                            $ StormX.DailyActions.append("tabno")
                        $ StormX.RecentActions.append("no sex")
                        $ StormX.DailyActions.append("no sex")
                        return
...
label Storm_SexPrep:
    ...
    if not StormX.Sex:
        if StormX.Forced:
            $ StormX.Statup("Love", 90, -150)
            $ StormX.Statup("Obed", 70, 60)
            $ StormX.Statup("Inbt", 80, 50)
        else:
    ...
    $ StormX.RecentActions.append("sex")
    $ StormX.DailyActions.append("sex")
...
label Storm_Sex_Cycle: #Repeating strokes
    while Round >=0:
        ...
        if Player.Focus >= 100 or StormX.Lust >= 100:
                    ...
                    if Line == "came": #ex Player.Focus <= 20:
                            ...
                            if not Player.Semen:
                                ...
                                jump Storm_SexAfter
                            elif "unsatisfied" in StormX.RecentActions:
        ...
        if StormX.SEXP >= 100 or ApprovalCheck(StormX, 1200, "LO"):
            pass
        elif Cnt == (5 + StormX.Sex):
                    $ StormX.Brows = "confused"
                    ch_s "Are you nearly finished?"
        elif Cnt == (10 + StormX.Sex):
                    $ StormX.Brows = "angry"
...
label Storm_Sex_A:
    ...
    if Taboo and "tabno" in StormX.DailyActions:
        $ temp_modifier -= 10
    if "no anal" in StormX.DailyActions:
        $ temp_modifier -= 5
        $ temp_modifier -= 10 if "no anal" in StormX.RecentActions else 0
    ...
    if not StormX.Anal and "no anal" not in StormX.RecentActions:
            #first time
            $ StormX.FaceChange("surprised", 1)
            $ StormX.Mouth = "kiss"
    ...
    if "anal" in StormX.RecentActions:
            $ StormX.FaceChange("sexy", 1)
            ch_s "Of course."
            jump Storm_AnalPrep
    ...
    if not StormX.Anal and Approval:
            ...
            elif "anal" in StormX.DailyActions and not StormX.Loose:
                pass
            elif "anal" in StormX.RecentActions:
                ch_s "I am properly stretched out. . ."
                jump Storm_AnalPrep
            elif "anal" in StormX.DailyActions:
                $ StormX.FaceChange("sexy", 1)
    ...
    if Approval >= 2:
            ...
            if StormX.Forced:
                ...
                $ StormX.Statup("Inbt", 60, 1)
                ch_s "Oh very well."
            elif "no anal" in StormX.DailyActions:
            ...
            #She's not into it, but maybe. . .
            $ StormX.FaceChange("angry")
            if "no anal" in StormX.RecentActions:
                ch_s "I am afraid that \"no\" is my final answer, [StormX.Petname]."
            elif Taboo and "tabno" in StormX.DailyActions and "no anal" in StormX.DailyActions:
                ch_s "I have already informed you. . . not in such an exposed location."
            elif "no anal" in StormX.DailyActions:
                ch_s "I believe that I just told you \"no,\" [StormX.Petname]."
            elif Taboo and "tabno" in StormX.DailyActions:
            ...
            menu:
                extend ""
                "Sorry, never mind." if "no anal" in StormX.DailyActions:
                    $ StormX.FaceChange("bemused")
                    ch_s "I cannot blame you for your. . . desires."
                    return
                "Maybe later?" if "no anal" not in StormX.DailyActions:
                    $ StormX.FaceChange("sexy")
                    ...
                    if Taboo:
                        $ StormX.RecentActions.append("tabno")
                        $ StormX.DailyActions.append("tabno")
                    $ StormX.RecentActions.append("no anal")
                    $ StormX.DailyActions.append("no anal")
                    return
...
label Storm_Anal_Cycle: #Repeating strokes
    while Round >=0:
        ...
        if StormX.SEXP >= 100 or ApprovalCheck(StormX, 1200, "LO"):
            pass
        elif Cnt == (5 + StormX.Anal):
                    $ StormX.Brows = "confused"
                    ch_s "So are you nearly finished?"
        elif Cnt == (10 + StormX.Anal):
                    $ StormX.Brows = "angry"
...
label Storm_Sex_H:
    ...
    if "no hotdog" in StormX.DailyActions:
        $ temp_modifier -= 5
        $ temp_modifier -= 10 if "no hotdog" in StormX.RecentActions else 0
            ...
            if (StormX.Hotdog and Approval) or (Approval > 1):                                                                      #this is not the first time you've had sex, or she's into it
                ...
                menu:
                    ...
                    "You'll see.":
                        ...
                        $ StormX.Statup("Obed", 70, 3)
                        $ StormX.Statup("Inbt", 50, 3)
                        if not ApprovalCheck(StormX, 500, "O", TabM=1): #Checks if Obed is 700+
                            $ StormX.FaceChange("angry")
    ...
    if not StormX.Hotdog and "no hotdog" not in StormX.RecentActions:
            #first time
            $ StormX.FaceChange("surprised", 1)
            $ StormX.Mouth = "kiss"
    ...
    if not StormX.Hotdog and Approval:
            ...
            elif "hotdog" in StormX.RecentActions:
                $ StormX.FaceChange("sexy", 1)
                ch_s "Again? Oh, very well."
                jump Storm_HotdogPrep
            elif "hotdog" in StormX.DailyActions:
                $ StormX.FaceChange("sexy", 1)
                $ Line = renpy.random.choice(["Back again so soon?",
                    "So you would like another round?",
    ...
    if Approval >= 2:
            ...
            if StormX.Forced:
                ...
                $ StormX.Statup("Inbt", 60, 1)
                ch_s "Fine then."
            elif "no hotdog" in StormX.DailyActions:
            ...
            #She's not into it, but maybe. . .
            $ StormX.FaceChange("angry")
            if "no hotdog" in StormX.RecentActions:
                ch_s "I am afraid that \"no\" is my final answer, [StormX.Petname]."
            elif Taboo and "tabno" in StormX.DailyActions and "no hotdog" in StormX.DailyActions:
            ...
            menu:
                extend ""
                "Sorry, never mind." if "no hotdog" in StormX.DailyActions:
                    $ StormX.FaceChange("bemused")
                    ch_s "There is no harm in asking."
                    return
                "Maybe later?" if "no hotdog" not in StormX.DailyActions:
                    $ StormX.FaceChange("sexy")
                    ...
                    if Taboo:
                        $ StormX.RecentActions.append("tabno")
                        $ StormX.DailyActions.append("tabno")
                    $ StormX.RecentActions.append("no hotdog")
                    $ StormX.DailyActions.append("no hotdog")
                    return
                "You might like it. . .":
                    if Approval:
                        $ StormX.FaceChange("sexy")
...
label Storm_Hotdog_Cycle: #Repeating strokes
    while Round >=0:
        ...
        if StormX.SEXP >= 100 or ApprovalCheck(StormX, 1200, "LO"):
            pass
        elif Cnt == (5 + StormX.Hotdog):
                    $ StormX.Brows = "confused"
                    ch_s "Are you nearly satisfied?"
        elif Cnt == (10 + StormX.Hotdog):
                    $ StormX.Brows = "angry"
                    menu:
