...
image Emma_squinting:
    "images/Emma_standing/Emma_standing_eyes_sexy.png"
    choice:
        3.5
    choice:
        3.25
...
image Emma_squinting_diamond:
    "images/Emma_standing/Emma_standing_eyes_sexy_diamond.png"
    choice:
        3.5
    choice:
        3.25
...
layeredimage Emma_standing_fondling_animations:
    if primary_action == "lesbian" or not girl_offhand_action or focused_Girl != EmmaX:
            Null()
    elif primary_action != "sex" and girl_offhand_action in "finger_pussy" and EmmaX.lust >= 70:
    ...
    if second_girl_primary_action != "masturbation" or not second_girl_offhand_action or focused_Girl == EmmaX:
        Null()
    elif primary_action != "sex" and second_girl_offhand_action == "finger_pussy" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if not primary_action or focused_Girl != EmmaX:
        Null()
    ...
    if not offhand_action or focused_Girl != EmmaX:
        Null()
    ...
    if not second_girl_primary_action or focused_Girl != EmmaX:
        Null()
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif second_girl_primary_action == "fondle_pussy" and primary_action != "sex" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif second_girl_primary_action == "fondle_pussy" and offhand_action != "sex" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if primary_action != "lesbian" or not girl_offhand_action or focused_Girl == EmmaX:
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif girl_offhand_action == "fondle_pussy" and primary_action != "sex" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif girl_offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
