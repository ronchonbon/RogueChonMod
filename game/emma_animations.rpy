...
layeredimage Emma_standing_fondling_animations:
    if Player.main_action == "lesbian" or not EmmaX.offhand_action or focused_Girl != EmmaX:
            Null()
    elif Player.main_action != "sex" and EmmaX.offhand_action in "finger_pussy" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif EmmaX.offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
    elif EmmaX.offhand_action == "fondle_breasts" and (Player.offhand_action in ["fondle_breasts", "suck breasts"]):
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif EmmaX.offhand_action == "fondle_breasts":
    ...
    if second_girl_main_action != "masturbation" or not second_girl_offhand_action or focused_Girl == EmmaX:
        Null()
    elif Player.main_action != "sex" and second_girl_offhand_action == "finger_pussy" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if not Player.main_action or focused_Girl != EmmaX:
        Null()
    ...
    if not Player.offhand_action or focused_Girl != EmmaX:
        ...
        "Zero_fondle_thigh_animation" pos (0.11, 0.68)
    elif Player.main_action == "fondle_breasts" and not EmmaX.offhand_action and not second_girl_main_action and not second_girl_offhand_action:
        "Zero_fondle_breasts_right_animation" pos (0.094, 0.38)
    ...
    if not second_girl_main_action or focused_Girl != EmmaX:
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif second_girl_main_action == "fondle_pussy" and Player.main_action != "sex" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if Player.main_action != "lesbian" or not EmmaX.offhand_action or focused_Girl == EmmaX:
        Null()
    elif EmmaX.offhand_action == "fondle_breasts" and Player.main_action in ["fondle_breasts", "suck_breasts"]:
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif EmmaX.offhand_action == "fondle_breasts" and Player.offhand_action in ["fondle_breasts", "suck_breasts"]:
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif EmmaX.offhand_action == "fondle_breasts":
        "Girl_fondle_breast_right_animation" pos (0.083, 0.352)
    elif EmmaX.offhand_action == "suck_breasts" and Player.main_action in ["fondle_breasts", "suck_breasts"]:
        "Zero_suck_breasts_left_animation" pos (0.146, 0.38)
    elif EmmaX.offhand_action == "suck_breasts" and Player.offhand_action in ["fondle_breasts", "suck_breasts"]:
        "Zero_suck_breasts_left_animation" pos (0.146, 0.38)
    elif EmmaX.offhand_action == "suck_breasts":
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif EmmaX.offhand_action == "fondle_pussy" and Player.main_action != "sex" and EmmaX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif EmmaX.offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
    elif EmmaX.offhand_action == "eat_pussy":
        "Zero_eat_pussy_animation" pos (0.13, 0.62)
