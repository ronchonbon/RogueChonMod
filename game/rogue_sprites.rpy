layeredimage Rogue_sprite:
    ...
    anchor (0.5, 0.0) offset (100, 180) zoom 0.95
...
layeredimage Rogue_doggy_body:
    ...
    if RogueX.eyes not in ["_squint", "_closed"]:
