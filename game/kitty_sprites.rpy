layeredimage Kitty_sprite standing:
    if KittyX.outfit["back_outer_accessory"]:
        "images/Kitty_standing/Kitty_standing_back_outer_accessory[KittyX.outfit[back_outer_accessory]].png"

    if KittyX.outfit["back_inner_accessory"]:
        "images/Kitty_standing/Kitty_standing_back_inner_accessory[KittyX.outfit[back_inner_accessory]].png"

    if KittyX.outfit["dress"]:
        "images/Kitty_standing/Kitty_standing_back_dress[KittyX.outfit[dress]].png"

    # if KittyX.outfit["underwear"]:
    #     "images/Kitty_standing/Kitty_standing_back_underwear[KittyX.outfit[underwear]].png"
    ...
    #     "images/Kitty_standing/Kitty_standing_clamps[KittyX.outfit[clamps]].png"

    # if KittyX.outfit["rope"]:
    #     "images/Kitty_standing/Kitty_standing_rope[KittyX.outfit[rope]].png"
    ...
    #     AlphaMask("grool_dripping", "images/Kitty_standing/Kitty_standing_grool_mask_underwear.png")
    # elif KittyX.grool == 1:
    #     AlphaMask("grool_dripping", "images/Kitty_standing/Kitty_standing_grool_mask.png")
    # elif KittyX.outfit["underwear"] and KittyX.underwear_pulled_down:
    #     AlphaMask("heavy_grool_dripping", "images/Kitty_standing/Kitty_standing_grool_mask_underwear.png")
    # elif KittyX.outfit["underwear"]:
    #     AlphaMask("grool_dripping", "images/Kitty_standing/Kitty_standing_grool_mask.png")
    # else:
    #     AlphaMask("heavy_grool_dripping", "images/Kitty_standing/Kitty_standing_grool_mask.png")
    ...
    #     Null()
    # elif KittyX.outfit["underwear"] and KittyX.underwear_pulled_down:
    #     AlphaMask("heavy_spunk_dripping", "images/Kitty_standing/Kitty_standing_grool_mask_underwear.png")
    # else:
    #     AlphaMask("heavy_spunk_dripping", "images/Kitty_standing/Kitty_standing_grool_mask.png")

    if KittyX.outfit["bottom"] and KittyX.upskirt:
        "images/Kitty_standing/Kitty_standing_bottom[KittyX.outfit[bottom]]_up.png"
    ...
    #     "images/Kitty_standing/Kitty_standing_loincloth[KittyX.outfit[loincloth]].png"

    # if KittyX.outfit["boots"]:
    #     "images/Kitty_standing/Kitty_standing_boots[KittyX.outfit[boots]].png"
    ...
    #     "images/Kitty_standing/Kitty_standing_piercings_pussy[KittyX.outfit[piercings]]_covered.png"
    ...
    #     "images/Kitty_standing/Kitty_standing_sleeves[KittyX.outfit[sleeves]][KittyX.arm_pose].png"
    ...
    #     "images/Kitty_standing/Kitty_standing_suspenders[KittyX.outfit[suspenders]][KittyX.arm_pose]_up.png"
    # elif KittyX.outfit["suspenders"] and KittyX.outfit["bottom"] and not KittyX.upskirt:
    #     "images/Kitty_standing/Kitty_standing_suspenders[KittyX.outfit[suspenders]][KittyX.arm_pose].png"

    # if KittyX.outfit["scarf"]:
    #     "images/Kitty_standing/Kitty_standing_scarf[KittyX.outfit[scarf]].png"

    if KittyX.outfit["jacket"]:
        "images/Kitty_standing/Kitty_standing_jacket[KittyX.outfit[jacket]].png"

    # if KittyX.outfit["cloak"]:
    #     "images/Kitty_standing/Kitty_standing_cloak[KittyX.outfit[cloak]].png"
...
layeredimage Kitty_head:
    ...
    #     "images/Kitty_standing/Kitty_standing_face_piercings[KittyX.outfit[face_piercings]].png"
