...
layeredimage Jubes_standing_fondling_animations:
    if Player.main_action == "lesbian" or not JubesX.offhand_action or focused_Girl != JubesX:
            Null()
    elif Player.main_action != "sex" and JubesX.offhand_action in "finger_pussy" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif JubesX.offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
    elif JubesX.offhand_action == "fondle_breasts" and (Player.offhand_action in ["fondle_breasts", "suck breasts"]):
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif JubesX.offhand_action == "fondle_breasts":
        "Girl_fondle_breast_right_animation" pos (0.083, 0.352)

    if second_girl_main_action != "masturbation" or not second_girl_offhand_action or focused_Girl == JubesX:
        Null()
    elif Player.main_action != "sex" and second_girl_offhand_action == "finger_pussy" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if not Player.main_action or focused_Girl != JubesX:
        Null()
    ...
    if not Player.offhand_action or focused_Girl != JubesX:
        Null()
    elif Player.offhand_action == "fondle_thighs":
        "Zero_fondle_thigh_animation" pos (0.11, 0.68)
    elif Player.main_action == "fondle_breasts" and not JubesX.offhand_action and not second_girl_main_action and not second_girl_offhand_action:
        "Zero_fondle_breasts_right_animation" pos (0.094, 0.38)
    ...
    if not second_girl_main_action or focused_Girl != JubesX:
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif second_girl_main_action == "fondle_pussy" and Player.main_action != "sex" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif second_girl_main_action == "fondle_pussy" and Player.offhand_action != "sex" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if Player.main_action != "lesbian" or not JubesX.offhand_action or focused_Girl == JubesX:
        Null()
    elif JubesX.offhand_action == "fondle_breasts" and Player.main_action in ["fondle_breasts", "suck_breasts"]:
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif JubesX.offhand_action == "fondle_breasts" and Player.offhand_action in ["fondle_breasts", "suck_breasts"]:
        "Girl_fondle_breast_left_animation" pos (0.156, 0.37)
    elif JubesX.offhand_action == "fondle_breasts":
        "Girl_fondle_breast_right_animation" pos (0.083, 0.352)
    elif JubesX.offhand_action == "suck_breasts" and Player.main_action in ["fondle_breasts", "suck_breasts"]:
        "Zero_suck_breasts_left_animation" pos (0.146, 0.38)
    elif JubesX.offhand_action == "suck_breasts" and Player.offhand_action in ["fondle_breasts", "suck_breasts"]:
        "Zero_suck_breasts_left_animation" pos (0.146, 0.38)
    elif JubesX.offhand_action == "suck_breasts":
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif JubesX.offhand_action == "fondle_pussy" and Player.main_action != "sex" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif JubesX.offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
    elif JubesX.offhand_action == "eat_pussy":
        "Zero_eat_pussy_animation" pos (0.13, 0.62)
