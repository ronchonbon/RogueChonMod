...
layeredimage Jubes_standing_fondling_animations:
    if main_action == "lesbian" or not girl_offhand_action or focused_Girl != JubesX:
            Null()
    elif main_action != "sex" and girl_offhand_action in "finger_pussy" and JubesX.lust >= 70:
    ...
    if second_girl_main_action != "masturbation" or not second_girl_offhand_action or focused_Girl == JubesX:
        Null()
    elif main_action != "sex" and second_girl_offhand_action == "finger_pussy" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if not main_action or focused_Girl != JubesX:
        Null()
    ...
    if not second_girl_main_action or focused_Girl != JubesX:
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif second_girl_main_action == "fondle_pussy" and main_action != "sex" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    ...
    if main_action != "lesbian" or not girl_offhand_action or focused_Girl == JubesX:
        ...
        "Zero_suck_breasts_right_animation" pos (0.083, 0.37)
    elif girl_offhand_action == "fondle_pussy" and main_action != "sex" and JubesX.lust >= 70:
        "Girl_finger_pussy_animation" pos (0.122, 0.583)
    elif girl_offhand_action == "fondle_pussy":
        "Girl_fondle_pussy_animation" pos (0.122, 0.569)
