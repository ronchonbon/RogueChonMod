...
label Kitty_Titjob:
    ...
    if KittyX.SeenChest and approval_check(KittyX, 500):
        $ approval_bonus += 10
...
label Kitty_Dildo_Ass:
    ...
    $ approval = approval_check(KittyX, 1450, TabM = 4)
...
label Kitty_Footjob:
    ...
    $ approval = approval_check(KittyX, 1250, TabM = 3)
