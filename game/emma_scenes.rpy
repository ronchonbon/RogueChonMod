...
label meet_Emma:
    ...
    if total_SEXP >= 110 or (len(Player.Harem) >= 2 and "Historia" not in Player.traits):
        $ EmmaX.change_stat("love", 70, 5)
        $ EmmaX.change_stat("obedience", 80, 10)
...
label Emma_Teacher_Caught(Girl=0):
    ...
    if "noticed " + Girl.tag in EmmaX.recent_history:
        return
    if approval_check(EmmaX, 500, "I") and approval_check(EmmaX, 1500) and EmmaX.GirlLikeCheck(Girl) >= 500:
            ...
            "But she's cool with it." if 2 not in Quest:
                ...
                if Girl.location == bg_current:
                    ...
                    if "poly Emma" in Girl.traits:
                        ...
                        if approval_check(Girl, 1500) and Girl.LikeEmma >= 800:
                            if Girl == RogueX:
                                ch_r "I really am."
                            elif Girl == KittyX:
                                ch_k "Yeah, you bet."
                                ...
                                ch_l "Sure."
                        elif approval_check(Girl, 1500) and Girl.LikeEmma >= 600:
                            if Girl == RogueX:
                                ch_r "Yeah, you'll do."
                            elif Girl == KittyX:
                                ch_k "Yeah, you're ok."
                        ...
                        elif approval_check(Girl, 500) and Girl.LikeEmma >= 800:
                            if Girl == RogueX:
